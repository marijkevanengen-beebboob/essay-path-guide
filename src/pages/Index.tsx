    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background via-50% to-accent/10 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full space-y-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group border-2 hover:border-primary/50 animate-fade-in-up" style={{animationDelay: "0.1s"}} onClick={() => navigate("/teacher")}>
            <CardHeader>
          ...
          <Card className="hover:shadow-2xl hover:scale-105 transition-all duration-300 cursor-pointer group border-2 hover:border-accent/50 animate-fade-in-up" style={{animationDelay: "0.2s"}} onClick={() => navigate("/student")}>
            <CardHeader>
        ...
        <div className="text-center text-sm text-muted-foreground animate-fade-in-up" style={{animationDelay: "0.3s"}}>
